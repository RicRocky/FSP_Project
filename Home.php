    ...
    <main>
        ...
        <div class="tableMember">
            <div class="card-home">
                ...
                <p class="text-center"><a href="ChangePassword.php">Ubah Password</a></p>
            </div>
            <?php
            if($_SESSION['role'] == "dosen") {
                echo '<div class="card-home">
                <img src="img/asset/icon-group1.png">
                <p class="text-center"><a href="ManageGroup.php">Lihat Daftar Group</a></p>
            </div>';
            }
            if($_SESSION['role'] == "mahasiswa") {
                echo '<div class="card-home">
                <img src="img/asset/icon-group1.png">
                <p class="text-center"><a href="ManageGroupMahasiswa.php">Group</a></p>
            </div>';
            }
            ?>
        </div>
